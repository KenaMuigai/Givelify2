...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private void saveUserData() {
        ...
        dcenterMap.put("role", "user");


        root.push().setValue(dcenterMap).addOnCompleteListener(task -> Toast.makeText(RegistrationActivity.this, "Data Saved Successfully", Toast.LENGTH_SHORT).show());
